...
const siteDescription =
  " Услуги в другом городе, выполняем полный спектр услуг в разных городах России для физических и юридических лиц. Каждый помощник проходит отбор: анкета, репутация, реальные задания. Оставляем только надёжных. Гарантия и скорость. Назначаем менеджера, контролируем сроки и качество.";
